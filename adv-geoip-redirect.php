...
Description: Redirect your visitors according to their geographical (country) location. Using the Maxmind GeoIP (Lite) Database (DB Last Updated : 2020-04-14).
Version: 1.0.0
...
if ( ! class_exists( 'GEOIPR_ADMIN_SETTINGS' ) ) :
	...
	class GEOIPR_ADMIN_SETTINGS
	{
		...
		public function save_settings_fields()
		{
			...
			// nonce is fine so process form fields
			}else{
